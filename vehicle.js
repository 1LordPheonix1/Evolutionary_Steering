class Vehicle{
	constructor(x, y, dna) {
		...
		this.healthRate = 0.008;
		this.nutritionalValue = [0.3, -0.5]; // plant, poison;

		// Mutation
		this.mr = 0.25; // mutation rate
		this.mrPercent = [10, 10, 25, 25]; // percent adjusted per dna[i];

		// Minimums and maximums for each index in dna array
		this.mins =  [-2, -2, 1,  1];
		this.maxes = [2,  2,  100, 100];
		// DNA
